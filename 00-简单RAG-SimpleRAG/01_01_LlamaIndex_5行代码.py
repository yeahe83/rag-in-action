...
# 设置OpenAI代理
Settings.llm = LlamaOpenAI(api_key=os.getenv("OPENAI_API_KEY"),api_base="https://aiyjg.lol/v1")
Settings.embed_model = OpenAIEmbedding(api_key=os.getenv("OPENAI_API_KEY"),api_base="https://aiyjg.lol/v1")
